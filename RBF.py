...
print """
                        ...
                        .s/.`   .+y+///ss          `.-:/+ooooshy/m+///+y/                           
                            ...
                            `m///////////h/   `:::+y+shN/////+ooso/-.                               
                             h+/////////h:`:++oy+++////yo+shdmd+`                                   
                             /y///////+h/+so+odh////++oso+oooohs                                    
                             `m//+hssymds+/////y++oo++///ohhhddd`                                   
                              h+//syoso/////+oys++////////ossssN-                                   
                              +y///++///+osdmmo/ss////////oyyyysh                                   
                              .d////+oss/-`shosmh+o+///////yhdddd/                                  
                               d+oss+-` -.  .ddo+hdo///////+ssooy/                                  
                               -/-`    +hh   ./ddy+sms////+oN:::-                                   
                                      .d/m     :sydmooh++++/m                                       
                                      ho/d.      shoy+d/////m                                       
                       ...
                       ./.-/--/.``-/-./-                                                            
                 -////`/+//./++++`+o+++`/////.//`` `..` :// `:                                      
                `NNss+sM+..oMo.mM/Mm:dM/MN.hMoMd...--.-`dmM//+                                      
                .syhNsmm`  dN..NdoNsdNo/Ny+o+oN+.``--`./+:Ndy.                                      
                :+++o.+o++.+o++o.+o.-o//o.   +o. ````` /. +o+  
...
logo = '\x1b[1;92m\n\x1b[1;93m* \x1b[1;97mAuthor  \x1b[1;91m: \x1b[1;96mRed Scorpion & Black Scorpion &Firemisk\x1b[1;97m\n\x1b[1;93m* \x1b[1;97mSupport \x1b[1;91m: \x1b[1;96mhttps://www.red-scorpion.org\x1b[1;97m[\x1b[1;96m\x1b[1;97m] \x1b[1;97m/ \x1b[1;96m\x1b[1;97m/ \x1b[1;96m\n\x1b[1;93m* \x1b[1;97mGitHub  \x1b[1;91m: \x1b[1;92m\x1b[4mhttps://github.com/Red-Scorpion-dev\x1b[0m\n[*] Decompiled by Red Scorpion & Black Scorpion &Firemisk\n'
...
#    ____  _____ ____    ____   ____ ___  ____  ____ ___ ___  _   _ 
#   |  _ \| ____|  _ \  / ___| / ___/ _ \|  _ \|  _ \_ _/ _ \| \ | |
#   | |_) |  _| | | | | \___ \| |  | | | | |_) | |_) | | | | |  \| |
#   |  _ <| |___| |_| |  ___) | |__| |_| |  _ <|  __/| | |_| | |\  |
#   |_| \_\_____|____/  |____/ \____\___/|_| \_\_|  |___\___/|_| \_|
#                                                                    
#                                                                                                   
...
"""
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.red-scorpion.org')
                time.sleep(2)
                menu()
...
def informasi():
    ...
    print logo
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    id = raw_input('\x1b[1;91m[+] \x1b[1;92mEnter ID\x1b[1;97m/\x1b[1;92mNama\x1b[1;91m : \x1b[1;97m')
    ...
    for p in cok['data']:
        if id in p['name'] or id in p['id']:
            ...
            try:
                ...
                print '\x1b[1;91m[?] \x1b[1;92mNama\x1b[1;97m          : \x1b[1;91mThere is no'
            else:
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print '\x1b[1;91m[?] \x1b[1;92mNomor HP\x1b[1;97m      : \x1b[1;91mThere is no'

                        try:
                            print '\x1b[1;91m[\xe2\x9e\xb9] \x1b[1;92mLokasi\x1b[1;97m        : ' + z['location']['name']
                        except KeyError:
                            print '\x1b[1;91m[?] \x1b[1;92mLokasi\x1b[1;97m        : \x1b[1;91mThere is no'
                ...
                try:
                    print '\x1b[1;91m[\xe2\x9e\xb9] \x1b[1;92mExercise\x1b[1;97m       : '
...
def mini():
    ...
    try:
        ...
        try:
            ...
            time.sleep(2)
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mMohon Wait a minute \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
...
def yahoolist():
    ...
    try:
        ...
        try:
            ...
            print '\x1b[1;91m[!] File There is no'
            raw_input('\n\x1b[1;91m[ \x1b[1;97mBack \x1b[1;91m]')
            menu_yahoo()
...
def id_teman():
    ...
    try:
        ...
        try:
            ...
            print '\n\r\x1b[1;91m[+] \x1b[1;97mID Number \x1b[1;96m%s' % len(idteman)
            ...
            print '\x1b[1;91m[\xe2\x9c\x96] There is no koneksi'
            keluar()
...
def menu_bot():
    ...
    print '\x1b[1;37;40m4. Bot Come Grup Post'
...
def wordlist():
    ...
    try:
        ...
        try:
            ...
            print logo
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            print '\x1b[1;91m[?] \x1b[1;92mIsi Fill in the complete target data below'
            print 40 * '\x1b[1;97m\xe2\x95\x90'
